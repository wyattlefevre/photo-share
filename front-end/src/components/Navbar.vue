<template>
  <div class="navbar">
    <v-app-bar app color="primary" dark>
      ...
      <router-link to='/'>
        <v-toolbar-title class="white--text text-uppercase">
          <span class="font-weight-normal accent--text">photo</span>
          <span class="font-weight-black ">share</span>
        </v-toolbar-title>
      </router-link>
    ...
    <v-navigation-drawer v-model="drawer" fixed temporary dark color="secondary">
      ...
      <v-list nav>
        <v-list-item v-for="link in links" :key="link.text" :to="link.route" @click="drawer = false">
